...
const SignUpForm = () => {
    ...
    const {createUser, googleLogin, userUpdate, loading, logOut} = useAuth();
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await logOut();
            toast.success('Sing Up Successful. Please Login.');
            navigate('/login');
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            ...
            <div data-aos="fade-left"  data-aos-duration="2000" className='border border-gray-500 shadow-xl rounded-lg w-[90%] sm:w-[500px] p-8 bg-gradient-to-t from-[#0C1725] to-[#0E272B]'>
                ...
                <div>
                    <h1 className='font-bold text-blue-500 text-4xl text-center mb-6'>Create An Account</h1>
                </div>
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            : 
                            <p className='text-gray-400 text-sm mt-1'>Please provide your full name.</p>
                            }
                        </div>
                        ...
                        <div className='mt-4'>
                            ...
                            : 
                            <p className='text-gray-400 text-sm mt-1'>Enter Your photoURL.</p>
                            }
                        </div>
                        ...
                        <div className='mt-4'>
                            ...
                            <button 
                            type="button"
                            className='absolute right-8 transform -translate-y-1/2 text-gray-400 hover:text-white'
                        ...
                        >
                            {loading ? <ImSpinner9 className='animate-spin mx-auto text-2xl text-white' /> : 'Create An Account'}
                        </button>
